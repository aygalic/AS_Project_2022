...
data_patient= read.delim(file.path("data_clinical_patient.txt"), header= TRUE, comment.char='#')

data_treatment_auc= read.delim(file.path("data_drug_treatment_auc.txt"), header=TRUE, comment.char='#')

data_sample= read.delim(file.path("data_clinical_sample.txt"), header= TRUE, comment.char='#')
