...
heatmap(data.matrix(cancer_data_treatment_auc))

image(data.matrix(cancer_data_treatment_auc))

heatmaply(cancer_data_treatment)

heatmaply(cancer_data_treatment, scale_fill_gradient_fun = ggplot2::scale_fill_gradient2(
    low = "red", 
    high = "green", 
    midpoint = 0.5, 
    limits = c(0, 1)
